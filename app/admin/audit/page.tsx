...
export default function Page() { return <AccountGate>{p => p.permissions.includes("audit.read") ? <AuditPage profile={p} /> : <AdminShell name={p.user.name}><h1>Admin access required</h1></AdminShell>}</AccountGate>; }
